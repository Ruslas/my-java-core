...
public class StudentDemo {
    public static void main(String[] args) {
        ...
        Aspirant aspirant1 = new Aspirant("Геннадий", "Вальтер", "ГР-13-1", 4.2);
        ...
        Aspirant aspirant2 = new Aspirant("Тимур", "Авдеев", "НП-17-2", 4.1);
        Aspirant aspirant3 = new Aspirant("Реал", "Магаз", "РН-17-2", 4.8);
